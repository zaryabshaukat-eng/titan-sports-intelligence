...
class ApiFootballFixtureAdapter(FixtureProviderAdapter):
    ...
    def normalize(self, payload: dict[str, Any]) -> NormalizedFixture:
        try:
            ...
            if source.league.code != self._season.country_provider_code:
                raise ValueError("fixture country does not match the confirmed import country")
            country_iso_code = normalize_api_football_country_code(source.league.code)
            ...
            return NormalizedFixture(
                ...
                country=NormalizedCountry(
                    provider_id=source.league.code,
        ...
        except (ApiFootballCountryNormalizationError, ValueError) as exc:
