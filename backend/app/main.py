...
from app.api.openapi import install_openapi_contracts
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    # Register before authentication: reverse middleware order means the
    # limiter executes after principal resolution and can apply role policy.
    ...
    install_openapi_contracts(app, resolved_settings)
